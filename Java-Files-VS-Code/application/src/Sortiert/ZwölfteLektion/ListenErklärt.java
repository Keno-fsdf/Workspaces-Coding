...
public class ListenErklärt {
    ...
    //Erste Klasse "Node", welche wir als 1. immmer brauchen für eine Liste
    ...
    public class Node {
        ...
        public Node (int val) {
            this.val = val;     //Wert für den Node
    ...
    public class LinkedList {
        ...
        public void insertAtTheEnd (int val) {
            ...
            Node newNode = new Node(val); //Wir müssen als erstes mal den Knotenpunkte / Node erstellen, denn wir dann am Ende der Liste hinzufügen wollen
    ...
    public static void main(String[] args) {
        ListenErklärt lottoList = new ListenErklärt();
