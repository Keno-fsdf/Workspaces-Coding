...
public class KreisKugel {
    public static void main(String[] args)  {
        ...
        double kreisfläche = Math.PI*r*r;  //Math.Pi = 3.14...    Math.pow  = radius hoch 2
        ...
        double kugelvolumen = 4/3*Math.PI*r*r*r; // ich hab den datentyp double benutzt, da die "Math.pow"-Funktion -->double Werte erwartet
