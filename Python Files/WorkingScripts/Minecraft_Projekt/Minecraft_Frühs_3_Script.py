...
sleep(1)
keyDown('capslock')
sleep(133,25) #how ever long you want
...
sleep(1)
keyDown('capslock')
sleep(134.5) #how ever long you want
keyUp("w") #stop pressing key 'a' down
keyUp('capslock')
keyUp('k')
keyDown('e')
...
sleep(1)
keyDown('capslock')
sleep(136) #how ever long you want
keyUp("w") #stop pressing key 'a' down
keyUp('capslock')
keyUp('k')
keyDown('e')
...
###############
sleep(1)
pyautogui.moveTo(750,909)
pyautogui.click()
pyautogui.moveTo(1260,678,1)
pyautogui.click()
pyautogui.moveTo(750,909,1)
pyautogui.click()
##############
#############
